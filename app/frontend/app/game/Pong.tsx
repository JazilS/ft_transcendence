...
//     player2: 0,
//   });
//   const [allData, setAllData] = useState<StartGameInfo | undefined>(undefined);

//   /* **/

//   useEffect(() => {
//     ConnectSocket();
//     mySocket.on(PongEvent.LETS_PLAY, (data) => {
//       alert(data);
//       setAllData(data);
//     }
//     );
...
//   // ) as StartGameInfo;
//   const room = allData?.room;
//   const creator = allData?.creator;
//   const opponent = allData?.opponent;
